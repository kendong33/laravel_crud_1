                ...
                <form action="{{ route('books.store') }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('book_name') is-invalid @enderror"
                            id="book_name" name="book_name" value="{{ old('book_name') }}" required>
                        @error('book_name')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('book_stock') is-invalid @enderror"
                            id="book_stock" name="book_stock" value="{{ old('book_stock', 0) }}" min="0" required>
                        @error('book_stock')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control @error('book_date') is-invalid @enderror"
                            id="book_date" name="book_date" value="{{ old('book_date') }}" required>
                        @error('book_date')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
